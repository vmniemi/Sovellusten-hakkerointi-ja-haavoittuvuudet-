...
Filellä paljastui että se on Microsoft Word tiedosto 
...
URLCHECKER siis tarkastaan sivun URL:n ennen kuin päästää käyttäjän sisälle.
...
Katsoin jos on plain text api tai muita salaisuuksia
...
katsoin vielä jos api on kovakoodattu
...
Koodissa oli myös mainintaa virustotalista, sitäkin voisi käyttää jotenkin?
