...
Fuffia käyttäessäni irrotin VM-koneen netistä
...
HUOM! näissä kaikissa kokeilussa muokkasin 
...
- Tämä on tyypillinen SQL-haavoittuvuus, jossa käyttäjän syöte ajetaan suoraan eikä välissä tapahdu mitään tarkastuksia tai sanitointia.
- Tämän korjaamiseksi pitää käyttää "prepared statements with bound parameters" eli käytännössä syötettä ei laiteta suoraan "pyörimään" vaan se otetaan talteen, jota ei kohdella kuin koodia vaan tekstinä 
...
class AdminDashboardView(UserPassesTestMixin, TemplateView):
  ...
  Itse haavoittuvuudesta:
  - Tekijä oli inhimillisesti unohtanut lisätä autentinkaatio kaikille sivuille
  - Sen korjaus oli yksinkertaista ja sen välttämiseksi olisi voinut esim. antaa kolmannen osapuolen tarkastaa koodin tai automaattitestauksella

        


g) Olin jo aikaisemmin tehnyt nämä tehtävät aikaisemmalla kurssilla, tarvitsin vain hieman muistinvirkistystä
Vapaaehtoinen. Johdantotehtävä, joka auttaa 010-staff-only ratkaisemisessa. Ratkaise Portswigger Academyn "Lab: SQL injection vulnerability in WHERE clause 
allowing retrieval of hidden data".
<img width="1117" height="483" alt="kuva" src="https://github.com/user-attachments/assets/8f24ebd2-5380-42c4-98e0-a29a3fafc4b4" />
...
<img width="1192" height="355" alt="kuva" src="https://github.com/user-attachments/assets/7aa6da56-ee40-4164-8dea-d846c37c12ab" />
