...
Ohjelman alkupiste, main functio luonti
    ...
    argv = pointteri jonoon, tässä tapauksessa argv[0], argv[1] etc.. 

	if (argc == 2) {

Tarkistaa  komentoriviparametrien määrän, jos on 2 jatkaa eteenpäin
...
Jos odotettuMerkki ei ole (lukuna) sama kuin käyttäjä syötetty syoteMerkki
